...
import CourseCertificate from "../../Custom/community/CourseCertificate";
import EditCourse from "../../Custom/community/EditCourse";
...
const Classroom = () => {
    ...
    const { singleCourseData, isSingleCourseLoading, refetchSingleCourse } =
    ...
    const { lessons, duration, name, summary, summaryPdfUrl } =
        singleCourseData || {};
    const { coursesWatched, _id } = userData || {};
    const { createdBy } = community || {};
    ...
    const [activeTab, setActiveTab] = useState(0); // 0 for course, 1 for certificate
    ...
    if (isSingleCourseLoading || isUserDataLoading || isCommunityLoading) {
        return <PageLoader />;
    }
    ...
    return (
        <Box
            ...
            {/* Tabs for course content and certificate */}
            {(completionPercentage >= 100 || isCreator) && (
            ...
            {activeTab === 1 && (
                <CourseCertificate
                    ...
                    communityCreator={community?.creatorName}
